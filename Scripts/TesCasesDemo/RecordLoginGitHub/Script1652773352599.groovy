...
WebUI.setText(findTestObject('Object Repository/Page_GitHub Where the world builds software_3c4b98/input_Email address_user_email'), 
    'thesapnadao@gmail.com')

WebUI.click(findTestObject('Object Repository/Page_GitHub Where the world builds software_3c4b98/button_Sign up for GitHub'))

WebUI.click(findTestObject('Object Repository/Page_Join GitHub  GitHub/a_Sign in'))
